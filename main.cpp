...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Bitalgo-seeder\n"
...
static const string mainnet_seeds[] = {"seeder.bitalgopay.com",""};
static const string testnet_seeds[] = {"testnet-seeder.bitalgopay.com", ""};
